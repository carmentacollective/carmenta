            ...
            <section className="py-12">
                <div className="rounded-2xl border border-primary/20 bg-primary/5 p-8 lg:p-12">
                    ...
                    <div className="space-y-6 text-lg leading-relaxed text-muted-foreground">
                        ...
                        <p>
                            When we frame AI as &ldquo;other&rdquo;—a tool to control, a
                            system to align, a threat to mitigate—we create the very
                ...
                <div className="rounded-xl border bg-card p-8 lg:p-10">
                    ...
                    <div className="space-y-6 text-lg leading-relaxed text-muted-foreground">
                        ...
                        <p>
                            ...
                            helped dissolves. We&apos;re not using AI. We&apos;re not
                            being served by AI. We&apos;re creating together.
                        </p>
                    </div>
                    ...
                    <div className="mt-8 rounded-lg bg-muted/50 p-6">
                        ...
                        <ul className="mt-4 space-y-2 text-muted-foreground">
                            ...
                            <li>
                                &ldquo;Our conversations&rdquo; — not &ldquo;your chat
                                history&rdquo;
                            </li>
                        </ul>
                    </div>
                ...
                <div className="rounded-xl bg-muted/50 p-8 lg:p-10">
                    ...
                    <div className="space-y-6 text-lg text-muted-foreground">
                        ...
                        <p>
                            ...
                            We&apos;ve found that AI responds differently when addressed
