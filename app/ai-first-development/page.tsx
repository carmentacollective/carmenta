...
export default function AIFirstDevelopmentPage() {
    return (
        <StandardPageLayout maxWidth="narrow" contentClassName="space-y-12 py-12">
            {/* Hero */}
            ...
            <section className="glass-card space-y-4 text-left">
                ...
                <div className="space-y-4 leading-relaxed text-foreground/80">
                    ...
                    <p>
                        A product is an ongoing dialogue between creators and users,
                        continuously shaped by signals, never finished. The
                        specification is a living model of intent that evolves as
                        understanding deepens.
                    </p>
                    <p>
                        Code is derived. The specification is the source of truth. When
                        understanding changes, implementation follows.
                    </p>
                </div>
            </section>
            ...
            <section className="glass-card space-y-4 text-left">
                ...
                <div className="space-y-4 leading-relaxed text-foreground/80">
                    ...
                    <p>
                        ...
                        planning, development, launch, feedback collection, analysis,
                        more planning. The loop takes quarters.
                    </p>
                    <p>AI-first products compress this to hours:</p>
                    <ol className="list-inside list-decimal space-y-1 pl-4">
                        <li>
                            AI agents test the product continuously, generating usage
                            signals
                        </li>
                        <li>
                            AI Product Manager synthesizes signals into specification
                            updates
                        </li>
                    ...
                    <p>
                        The product improves while you sleep. Feedback flows directly
                        into improvement. The structural advantage compounds.
                    </p>
                </div>
            </section>
            ...
            <section className="glass-card space-y-4 text-left">
                ...
                <div className="space-y-4 leading-relaxed text-foreground/80">
                    ...
                    <p>
                        ...
                        genuinely unprecedented, human creativity leads. AI accelerates
            ...
            <section className="glass-card space-y-4 text-left">
                ...
                <div className="space-y-4 leading-relaxed text-foreground/80">
                    ...
                    <p>
                        The specification is not a markdown file. It is a living model
                        of intent, maintained by the system, viewable as documents but
                        not limited to them.
                    </p>
                    <p>
                        Human creative capacity to imagine what is worth building
                        becomes the constraint. The translation to running software is
                        nearly instantaneous. The product converges toward user needs
                        automatically.
                    </p>
                </div>
            </section>
            ...
            <section className="glass-card space-y-4 text-left">
                ...
                <div className="space-y-4 leading-relaxed text-foreground/80">
                    <p>
                        ...
                        version control. Code is generated from it. The specification is
                        the IP.
                    </p>
                    <p>
                        We&apos;re building in public so you can watch the methodology
                        in action. The flywheel—agents test, AI PM synthesizes, AI
                        builds—is how we improve Carmenta together.
                    </p>
            ...
            <section className="space-y-4 text-center">
                <p className="text-muted-foreground">Want to see this in practice?</p>
