                    ...
                    <div className="prose prose-lg dark:prose-invert mt-8 max-w-none">
                        ...
                        <section className="mt-8">
                            ...
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                                ...
                                <li>
                                    Maintain conversation context across different
                                    models
                                </li>
                                <li>
                        ...
                        <section className="mt-8">
                            ...
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                                <li>
                                    Be at least 13 years old (or the age of majority in
                                    our jurisdiction)
                                </li>
                                <li>Provide accurate and complete information</li>
                                <li>Keep our account credentials secure</li>
                                <li>
                                    Notify Carmenta immediately if we detect
                                    unauthorized access
                                </li>
                            </ul>
                            ...
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                                ...
                                <li>
                                    Any costs or damages resulting from our account
                                    usage
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="mt-8">
                            ...
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                                ...
                                <li>
                                    Scrape, crawl, or index the Service without
                                    permission
                                </li>
                                <li>
                                    Resell or redistribute the Service without
                                    authorization
                                </li>
                                <li>
                                ...
                                <li>
                                    Reverse engineer or attempt to extract our source
                                    code
                                </li>
                                <li>
                        ...
                        <section className="mt-8">
                            ...
                            <p className="mt-4">
                                When we use AI models through Carmenta:
                            </p>
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                                <li>
                                    Our requests are processed by third-party AI
                                ...
                                <li>
                                    We're not responsible for the accuracy,
                                    completeness, or appropriateness of AI-generated
                                    content
                                </li>
                                <li>
                        ...
                        <section className="mt-8">
                            ...
                            <p className="mt-4">
                                Our Service includes reasonable usage limits to ensure
                                fair access for all users. We may:
                            </p>
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                                <li>Implement rate limits on API requests</li>
                                <li>
                                    Throttle or temporarily restrict excessive usage
                                </li>
                                <li>
                        ...
                        <section className="mt-8">
                            ...
                            <p className="mt-4">
                                ...
                                using our Service, we grant ourselves a limited license
                                to:
                            </p>
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                                <li>
                                ...
                                <li>
                                    Use anonymized usage data to improve the Service
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="mt-8">
                            ...
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                                ...
                                <li>
                                    That the Service will meet your specific
                                    requirements
                                </li>
                                <li>
                        ...
                        <section className="mt-8">
                            ...
                            <p className="mt-4">
                                ...
                                ACCURATE, COMPLETE, RELIABLE, OR APPROPRIATE FOR OUR
                                USE. WE ARE RESPONSIBLE FOR VERIFYING AND VALIDATING ALL
                        ...
                        <section className="mt-8">
                            ...
                            <p className="mt-4">
                                TO THE FULLEST EXTENT PERMITTED BY LAW, CARMENTA SHALL
                        ...
                        <section className="mt-8">
                            ...
                            <p className="mt-4">
                                We may terminate or suspend our account and access to
                                the Service:
                            </p>
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                                ...
                                <li>
                                    If our account is inactive for an extended period
                                </li>
                                <li>At our discretion, with or without notice</li>
                            </ul>
                            <p className="mt-4">
                                We can terminate our account at any time through
                                Carmenta. Upon termination:
                            </p>
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                        ...
                        <section className="mt-8">
                            ...
                            <p className="mt-4">
                                Our continued use of the Service after changes
                        ...
                        <section className="mt-8">
                            ...
                            <p className="mt-4">
                                ...
                                to try to resolve it informally. We'll work in good
