                    ...
                    <div className="mt-8 rounded-xl border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-background p-6">
                        ...
                        <div className="space-y-3">
                            <p className="font-medium">
                                We built Carmenta to be a heart-centered AI interface
                                for builders who work at the speed of thought. Here's
                                what that means for our privacy:
                            </p>
                            ...
                            <div className="mt-4">
                                ...
                                <ul className="list-disc space-y-1 pl-6 text-sm">
                                    ...
                                    <li>
                                        Conversations with AI models (to maintain
                                        context and improve our shared experience)
                                    </li>
                                    <li>
                                        Model preferences and usage patterns (which
                                        models we use and when)
                                    </li>
                                    <li>
                                        Technical logs (API requests, timestamps,
                                        response status) for 90 days
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="mt-4">
                                ...
                                <ul className="list-disc space-y-1 pl-6 text-sm">
                                    <li>
                                        Delete conversations or our entire account
                                        anytime
                                    </li>
                            ...
                            <p className="mt-4 border-t border-primary/20 pt-4 text-sm font-medium">
                                How we work: We unify multiple AI models (Claude,
                                ChatGPT, Gemini, and more) into one interface. Our
                                conversations are stored to maintain context across
                                models and sessions. We route our requests to the best
                                model for each task, always prioritizing our
                                flourishing.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="prose prose-lg dark:prose-invert mt-8 max-w-none">
                        <section className="mt-8">
                            ...
                            <p className="mt-4">
                                ...
                                and share our information. This Privacy Policy explains
                                our practices regarding data we collect through our
                                service.
                            </p>
                        </section>
                        ...
                        <section className="mt-8">
                            ...
                            <p className="mt-2">
                                When we create an account, we collect:
                            </p>
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                                ...
                                <li>
                                    Authentication credentials (managed securely by
                                    Clerk)
                                </li>
                            </ul>
                        ...
                        <section className="mt-8">
                            ...
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                                ...
                                <li>
                                    Maintain conversation context across sessions and
                                    models
                                </li>
                        ...
                        <section className="mt-8">
                            ...
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                                <li>
                                    <strong>Authentication:</strong> Managed by Clerk
                                ...
                                <li>
                                    <strong>Transmission:</strong> All data transmitted
                                    over HTTPS
                                </li>
                                <li>
                                    <strong>Access Control:</strong> Strict user
                                    isolation - we can only access our own data
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="mt-8">
                            ...
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                                ...
                                <li>
                                    <strong>AI Model Providers:</strong> Anthropic
                                    (Claude), OpenAI (ChatGPT), Google (Gemini), and
                                    others
                                </li>
                                <li>
                            ...
                            <p className="mt-4">
                                ...
                                conversations are processed by AI model providers
                                according to their terms and privacy practices.
                            </p>
                        </section>
                        ...
                        <section className="mt-8">
                            ...
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                                ...
                                <li>
                                    <strong>Export:</strong> Download our conversations
                                    and data
                                </li>
                                <li>
                        ...
                        <section className="mt-8">
                            ...
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                                ...
                                <li>
                                    <strong>Conversations:</strong> Until we delete them
                                    or our account
                                </li>
                                <li>
                                    <strong>Usage Logs:</strong> For 90 days (for
                                    debugging and analytics)
                                </li>
                                <li>
                                    <strong>Legal Requirements:</strong> Longer if
                                    required by law
                                </li>
                            </ul>
                            ...
                            <ol className="mt-2 list-decimal space-y-2 pl-6">
                                ...
                                <li>
                                    We'll confirm identity and process the request
                                    within 30 days
                                </li>
                                <li>
                                    All account data, conversations, and settings will
                                    be permanently deleted
                                </li>
                                <li>
                                    Usage logs will be purged or anonymized within 90
                                    days of deletion
                                </li>
                            </ol>
                        </section>
                        ...
                        <section className="mt-8">
                            ...
                            <p className="mt-4">
                                Our service is hosted in the United States. When
                                accessing from outside the US, information will be
                                transferred to, stored, and processed in the US where
                        ...
                        <section className="mt-8">
                            ...
                            <p className="mt-4">
                                Carmenta is built for adults creating meaningful work.
                                We don't knowingly collect information from anyone under
                                13. If we discover we've collected such information,
                        ...
                        <section className="mt-8">
                            ...
                            <p className="mt-4">
                                ...
                                We'll notify ourselves of significant changes by:
                            </p>
                            <ul className="mt-2 list-disc space-y-2 pl-6">
