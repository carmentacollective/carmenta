...
export function OptionList({
    ...
    // Normalize selection when mode/limits change - this is intentional state sync
    useEffect(() => {
    ...
    // Reset active index when options change - this is intentional state sync
    useEffect(() => {
    ...
    const updateSelection = useCallback(
        ...
        [effectiveMaxSelections, selectionMode, uncontrolledSelected, value, onChange]
    );
    ...
    if (confirmed !== undefined && confirmed !== null) {
        const confirmedIds = parseSelectionToIdSet(confirmed, selectionMode);
        return (
