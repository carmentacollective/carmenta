...
export const MessageBranchContent = ({
    ...
    // Memoize to prevent useEffect dep from changing on every render
...
export function MessageAttachment({
    ...
    return (
        ...
        >
            {isImage ? (
                <>
                    {/* eslint-disable-next-line @next/next/no-img-element -- User-provided dynamic URLs, small thumbnail */}
                    <img
