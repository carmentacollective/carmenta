...
/**
 * Animated title component with character-by-character reveal.
 * Creates a delightful "typing" effect when a new title appears.
 * Uses Framer Motion for smooth staggered character animations.
 */
function AnimatedTitle({ title }: { title: string }) {
    ...
    return (
        <motion.span
            key={title}
            className="flex truncate text-sm text-foreground/70"
            initial="hidden"
            animate="visible"
            variants={{
                hidden: {},
...
export function ConnectHeader() {
    ...
    // Header should be visible once loaded (including /connection/new with no active connection)
    const shouldShowHeader = isLoaded;
