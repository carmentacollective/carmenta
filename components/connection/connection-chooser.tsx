    ...
    return (
        <div className="group/title flex items-center gap-1.5">
            ...
            <button
                ...
                className="btn-subtle-text flex items-center gap-2 rounded-md border border-transparent px-1.5 py-0.5 transition-all hover:border-foreground/10 hover:bg-foreground/[0.03] focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-primary/40 active:scale-[0.98]"
    ...
    return (
        ...
        >
            ...
            <button
                ...
                className="relative flex flex-1 items-center gap-3 rounded-md text-left transition-all focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-primary/40 group-hover:translate-x-0.5"
            >
                <span
                    className={cn(
                    ...
                    {hasTitle ? (
                        ...
                        >
                            ...
                            <button
                                ...
                                className="btn-subtle-icon text-foreground/40 hover:text-foreground/60 focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-primary/40 active:scale-[0.92]"
                            ...
                            <button
                                ...
                                disabled={isPending}
                                className={cn(
                                    "flex items-center justify-center transition-all duration-200 focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-primary/40",
                                    isMobilePlacement
                        ...
                        >
                            ...
                            <button
                                onClick={openDropdown}
                                className={cn(
                                    "btn-subtle flex items-center gap-2 text-sm text-foreground/60 hover:text-foreground/80 focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-primary/40 active:scale-[0.98]",
                            ...
                            {isMobilePlacement && (
                                <button
                                    onClick={createNewConnection}
                                    disabled={isPending}
                                    className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-md transition-all duration-200 hover:bg-primary/90 hover:shadow-lg focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-primary/40 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
                                    aria-label="New connection"
                                    data-tooltip-id="tip"
                                    data-tooltip-content="Start fresh"
                                >
