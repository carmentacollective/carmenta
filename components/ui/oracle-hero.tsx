...
export function OracleHero() {
    return (
        <div className="flex min-h-[60vh] flex-col items-center justify-center px-6 py-12">
            ...
            <Link
                href="/connection/new"
                className="group/btn relative overflow-hidden rounded-full bg-white/80 px-8 py-3 shadow-lg backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl"
            >
