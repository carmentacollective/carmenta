 ...
 *   Note: Use generatedByDefaultAsIdentity (not generatedAlwaysAsIdentity) for
 *   compatibility with Drizzle ORM's insert behavior which explicitly passes DEFAULT
 *
