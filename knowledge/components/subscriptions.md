...
Turn usage into revenue - the business model that sustains Carmenta and aligns value
delivered with value captured.

## Why This Exists

Carmenta costs money to run. Every LLM request, every voice transcription, every service
connection has real costs. A sustainable business requires capturing value proportional
to value delivered.
...
operations: pricing tiers, payment processing, plan management, and the UX around all of
it.
...
The right model depends on who our users are and how they use Carmenta. Research needed.
...
The UX here matters enormously. Heavy-handed blocking frustrates users. Too soft means
...
- **Price points**: What do target users pay for similar tools? What's the value-based
  price vs. cost-based floor?
...
- **Payment processor**: Stripe (standard), Paddle (merchant of record), LemonSqueezy,
  or others?
...
- **Competitive pricing**: What do ChatGPT Plus, Claude Pro, Perplexity Pro charge? What
