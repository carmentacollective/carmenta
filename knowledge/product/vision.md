...
In a world where AI can build anything, the bottleneck shifts from engineering capacity
to clarity of thought. The interface to AI becomes the leverage point for everything
else.

Current tools are fragmented. ChatGPT, Claude.ai, Cursor, Claude Code - each good, none
complete. Context doesn't persist. Conversations start fresh. There's no team, just you
and a chat window.
...
Carmenta implements the [100x Framework](./context/100x-framework.md):
...
letters into the writing system that would carry Western civilization's knowledge for
millennia. The alphabet may be the most transformative technology in human history: it
enabled law, literature, science, and the transmission of ideas across time and space.
...
Carmenta is the goddess of technology in service of human flourishing. That's the
