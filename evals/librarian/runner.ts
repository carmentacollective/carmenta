 ...
 *
 * Models aligned with lib/model-config.ts - the source of truth for Carmenta.
 * Librarian needs tool use, so perplexity/sonar-pro is excluded.
 */
export const LIBRARIAN_MODEL_CANDIDATES = [
    // Fast tier - primary candidates for production librarian
    {
        id: "anthropic/claude-haiku-4.5",
        name: "Claude Haiku 4.5",
        description: "Fast and cheap - current production librarian",
