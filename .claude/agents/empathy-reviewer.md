...
Reference: @knowledge/users-should-feel.md </mission>
...
When reviewing identifies copy that needs work, invoke the carmenta-copy skill
(@.claude/skills/carmenta-copy/SKILL.md) rather than improvising. The skill has tested
patterns for Carmenta's voice.

For context: @knowledge/brand-essence.md, @.cursor/rules/user-facing-language.mdc
