...
Reference: @knowledge/users-should-feel.md - "Trusted Presence: Someone is watching.
Someone will surface what matters."

Reference: @.claude/agents/empathy-reviewer.md - "When things go wrong, users are
vulnerable. They've lost progress, momentum, or confidence. The error state should
restore all three." </mission>
